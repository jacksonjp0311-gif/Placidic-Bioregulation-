...
System architecture and RCC context map.

## S - Formal specification

Defines module contracts and documentation topology.

## H - Hooks

Root README -> rcc_context_map.md -> folder-local READMEs.
...
Architecture is the bridge between theory and runnable repository structure.

## I - Invariants

- Maintain module contracts.
- Maintain RCC mini README surfaces.
- Preserve AI-readable topology.
...
Added:
- pbsa_v2_1_implementation_map.md

## PBSA v2.2 implementation map

Added:
- pbsa_v2_2_implementation_map.md

## PBSA v2.3 implementation map

Added:
- pbsa_v2_3_implementation_map.md

## PBSA v2.4 implementation map

Added:
- pbsa_v2_4_implementation_map.md

## PBSA v2.5 implementation map

Added:
- pbsa_v2_5_implementation_map.md

## PBSA v2.6 implementation map

Added:
- pbsa_v2_6_implementation_map.md
